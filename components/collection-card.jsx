...
export default function CollectionCard({collection}) {
  ...
  return (
    <div className='border m-1 relative overflow-hidden h-[16rem] md:h-[15rem] lg:h-[17rem] max-w-[30rem] md:max-w-none md:w-[16rem] lg:w-[21rem] xl:w-[26rem] after:absolute text-white after:text-white bg-transparent after:bg-primary-color after:opacity-90 after:top-0 after:-left-[14rem] after:md:-left-[13rem] after:lg:-left-[17rem] after:w-full after:lg:w-[90%] after:h-full after:origin-bottom-left after:skew-x-[-38deg] lg:after:skew-x-[-45deg]'>
